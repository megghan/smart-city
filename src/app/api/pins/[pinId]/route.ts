...
export async function DELETE(
    ...
    try {
        ...
        // 1. PRIMEIRA ETAPA CRUCIAL: EXCLUIR REGISTROS RELACIONADOS (RATINGS)
        // O erro P2003 indicou a chave 'Rating_pinId_fkey', então o campo na tabela Rating é 'pinId'.
        ...
        // 2. EXCLUSÃO AUTORIZADA: Agora que os Ratings foram excluídos, podemos deletar o Pin.
